...
namespace WindSlicer.Win32
{
    ...
    */
    ...
    public enum ShowWindowCommands
    {
        ...
        /// not responding. This flag should only be used when minimizing windows from a different
        /// thread.
        /// </summary>
        ForceMinimize = 11
    }
    ...
    /// <summary>
    /// Flags used by the DwmGetWindowAttribute and DwmSetWindowAttribute functions to specify window
    /// attributes for non-client rendering.
    /// </summary>
    public enum DwmWindowAttribute : uint
    {
        /// <summary>
        /// Determines whether non-client rendering is enabled. Use this value only with
        /// DwmGetWindowAttribute. The retrieved value is of type BOOL. TRUE if non-client rendering
        /// is enabled; otherwise, FALSE.
        /// </summary>
        DWMWA_NCRENDERING_ENABLED = 1,
        /// <summary>
        /// The non-client rendering policy. Use this value only with DwmSetWindowAttribute, with its
        /// pvAttribute pointing to a value from the DWMNCRENDERINGPOLICY enumeration.
        /// </summary>
        DWMWA_NCRENDERING_POLICY,
        /// <summary>
        /// Enable or forcibly disable DWM transitions. Use this value only with
        /// DwmSetWindowAttribute, with its pvAttribute pointing to a value of TRUE to disable
        /// transitions or FALSE to enable transitions.
        /// </summary>
        DWMWA_TRANSITIONS_FORCEDISABLED,
        /// <summary>
        /// Allow content rendered in the non-client area to be visible on the frame drawn by DWM.
        /// Use this value only with DwmSetWindowAttribute, with its pvAttribute pointing to a value
        /// of TRUE to allow content rendered in the non-client area to be visible on the frame;
        /// otherwise, FALSE.
        /// </summary>
        DWMWA_ALLOW_NCPAINT,
        /// <summary>
        /// Retrieves the bounds of the caption button area in the window-relative space. Use this
        /// value only with DwmGetWindowAttribute. The retrieved value is of type RECT.
        /// </summary>
        DWMWA_CAPTION_BUTTON_BOUNDS,
        /// <summary>
        /// Specifies whether non-client content is right-to-left (RTL) mirrored. Use this value only
        /// with DwmSetWindowAttribute, with its pvAttribute pointing to a value of TRUE if the
        /// non-client content is right-to-left (RTL) mirrored; otherwise, FALSE.
        /// </summary>
        DWMWA_NONCLIENT_RTL_LAYOUT,
        /// <summary>
        /// Force the window to display an iconic thumbnail or peek representation (a static bitmap),
        /// even if a live or snapshot representation of the window is available. This value normally
        /// is set during a window's creation and not changed throughout the window's lifetime. Some
        /// scenarios, however, might require the value to change over time. Use this value only with
        /// DwmSetWindowAttribute, with its pvAttribute pointing to a value of TRUE to require a
        /// iconic thumbnail or peek representation; otherwise, FALSE.
        /// </summary>
        DWMWA_FORCE_ICONIC_REPRESENTATION,
        /// <summary>
        /// Sets how Flip3D treats the window. Use this value only with DwmSetWindowAttribute, with
        /// its pvAttribute pointing to a value from the DWMFLIP3DWINDOWPOLICY enumeration.
        /// </summary>
        DWMWA_FLIP3D_POLICY,
        /// <summary>
        /// Retrieves the extended frame bounds rectangle in screen space. Use this value only with
        /// DwmGetWindowAttribute. The retrieved value is of type RECT.
        /// </summary>
        DWMWA_EXTENDED_FRAME_BOUNDS,
        /// <summary>
        /// The window can provide a bitmap for use by DWM as an iconic thumbnail or peek
        /// representation (a static bitmap) for the window. This value can be specified with
        /// DWMWA_FORCE_ICONIC_REPRESENTATION. This value normally is set during a window's creation
        /// and not changed throughout the window's lifetime. Some scenarios, however, might require
        /// the value to change over time. Use this value only with DwmSetWindowAttribute, with its
        /// pvAttribute pointing to a value of TRUE to inform DWM that the window will provide an
        /// iconic thumbnail or peek representation; otherwise, FALSE.
        /// </summary>
        DWMWA_HAS_ICONIC_BITMAP,
        /// <summary>
        /// Do not show peek preview for the window. The peek view shows a full-sized preview of the
        /// window when the mouse hovers over the window's thumbnail in the taskbar. If this
        /// attribute is set, hovering the mouse pointer over the window's thumbnail dismisses peek
        /// (in case another window in the group has a peek preview showing). Use this value only
        /// with DwmSetWindowAttribute, with its pvAttribute pointing to a value of TRUE to prevent
        /// peek functionality; FALSE to allow it.
        /// </summary>
        DWMWA_DISALLOW_PEEK,
        /// <summary>
        /// Prevents a window from fading to a glass sheet when peek is invoked. Use this value only
        /// with DwmSetWindowAttribute, with its pvAttribute pointing to a value of TRUE to prevent
        /// the window from fading during another window's peek; FALSE for normal behavior.
        /// </summary>
        ...
        DWMWA_CLOAKED,
        /// <summary>
        /// Use with DwmSetWindowAttribute. Freeze the window's thumbnail image with its current
        /// visuals. Do no further live updates on the thumbnail image to match the window's
        /// contents.
        /// </summary>
    ...
    /// <remarks>
    /// Only values that work with .NET are WH_KEYBOARD_LL and WH_MOUSE_LL. See
    /// https://support.microsoft.com/en-us/help/318804
    /// </remarks>
    ...
    public enum WindowStylesEx : uint
    {
        ...
        /// <summary>
        /// Specifies a palette window, which is a modeless dialog box that presents an array of
        /// commands.
        /// </summary>
    ...
    public enum WM : uint
    {
        ...
        /// separate user-input messages from other messages sent through the WH_JOURNALPLAYBACK Hook
        /// procedure.
        /// </summary>
        QUEUESYNC = 0x0023,
        /// <summary>
        ...
        /// and carry out any other initialization tasks that affect the appearance of the dialog
        /// box.
        /// </summary>
        INITDIALOG = 0x0110,
        /// <summary>
        ...
        /// and background colors of the message box by using the given display device context
        /// handle.
        /// </summary>
        ...
        /// identified by the wParam parameter of the WM_CPL_LAUNCH message that started the
        /// application.
        /// </summary>
